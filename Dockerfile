...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libsqlite3-0 libvips libjemalloc2 ffmpeg redis build-essential git pkg-config libpq-dev default-libmysqlclient-dev openssl && \
